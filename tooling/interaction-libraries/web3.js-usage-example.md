...
In order to be able to use the web3.js library to interact with the [predeployed smart contract](../../network/precompiled-and-predeployed-smart-contracts/), we need to add it as well as the precompiled smart contracts to the projects:
